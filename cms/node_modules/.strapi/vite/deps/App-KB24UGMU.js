...
import "./chunk-4SKSB4OR.js";
import "./chunk-3UMPUW2F.js";
import "./chunk-ALXWY7MY.js";
import "./chunk-LQU5YWEE.js";
import "./chunk-IMOFKNEI.js";
import "./chunk-CKWBRNOU.js";
import "./chunk-5VWFAMMQ.js";
import "./chunk-BDTHLZ2Z.js";
import "./chunk-QIJGNK42.js";
import "./chunk-GCYVCY27.js";
import "./chunk-MERGPFMT.js";
import "./chunk-BRU3VOWE.js";
import "./chunk-SACLHMTW.js";
import "./chunk-VB2WZ4KM.js";
import "./chunk-62YJ2OJO.js";
import "./chunk-PBPUW6NO.js";
import "./chunk-XXZUQKB2.js";
import "./chunk-GQ3H22RD.js";
import "./chunk-2WXBDYZB.js";
import "./chunk-QJ4RHZ5C.js";
import "./chunk-TYNJWFIM.js";
import {
  SearchInput
} from "./chunk-47TBL6HA.js";
import "./chunk-TVWSY6K7.js";
import "./chunk-4RG3D6XM.js";
import "./chunk-MBK4V2X7.js";
import "./chunk-RFLDFAFR.js";
import "./chunk-BWT2CGTF.js";
import "./chunk-5MRKZKMI.js";
import "./chunk-YM36M4AP.js";
import "./chunk-VVLJBHWR.js";
import "./chunk-UUPFYJ35.js";
import "./chunk-IFOFBKTA.js";
import "./chunk-743NLXIP.js";
import "./chunk-Z6T66C2C.js";
import "./chunk-Q6J7TQ5B.js";
import {
  Layouts
} from "./chunk-DCYHW3AB.js";
import {
  useIsMobile
} from "./chunk-OV2MXBWE.js";
import "./chunk-K55EVFVC.js";
import "./chunk-S2ZKPODU.js";
...
import "./chunk-YHGBEAI6.js";
import "./chunk-SGS52J67.js";
import {
  useNotification
...
var ToggleGroup = import_react3.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime10.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime10.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react3.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime10.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime10.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react3.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime10.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime10.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react3.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime10.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime10.jsx)(
      Root,
      {
        asChild: true,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime10.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime10.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react3.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime10.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime10.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime10.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var { useUploadFilesMutation } = uploadApi;
...
var AssetPreview = ({ asset }) => {
  ...
  if (mime == null ? void 0 : mime.includes(AssetType.Image)) {
    ...
    if (mediaURL) {
      return (0, import_jsx_runtime11.jsx)(PreviewContainer, {
        children: (0, import_jsx_runtime11.jsx)(StyledImage, {
          src: mediaURL,
          alt: alternativeText || ""
        })
      });
  ...
  return (0, import_jsx_runtime11.jsx)(PreviewContainer, {
    children: (0, import_jsx_runtime11.jsx)(IconPreview, {
      justifyContent: "center",
      alignItems: "center",
      children: (0, import_jsx_runtime11.jsx)(DocIcon, {
        width: 48,
        height: 48
      })
    })
...
var StyledCardHeader = lt(Pm)`
  border-bottom: none;
`;
var CardFooter = lt(T)`
  min-width: 0;
`;
var FileTypeIcon = lt(T)`
...
var AssetCard = ({ asset }) => {
  ...
  return (0, import_jsx_runtime11.jsxs)(StyledCard, {
    children: [
      (0, import_jsx_runtime11.jsx)(StyledCardHeader, {
        children: (0, import_jsx_runtime11.jsx)(AssetPreview, {
          asset
        })
      }),
      (0, import_jsx_runtime11.jsx)(Om, {
        children: (0, import_jsx_runtime11.jsxs)(CardFooter, {
          alignItems: "center",
          gap: 2,
          paddingTop: 2,
          children: [
            (0, import_jsx_runtime11.jsx)(FileTypeIcon, {
              children: (0, import_jsx_runtime11.jsx)(TypeIcon, {
                width: 16,
                height: 16
              })
            }),
            (0, import_jsx_runtime11.jsx)(FileName, {
              textColor: "primary800",
              ellipsis: true,
              children: asset.name
            }),
            (0, import_jsx_runtime11.jsx)(ot, {
              label: formatMessage({
                id: getTranslationKey("control-card.more-actions"),
                defaultMessage: "More actions"
              }),
              variant: "ghost",
              children: (0, import_jsx_runtime11.jsx)(E3, {})
            })
          ]
        })
      })
...
var AssetsGrid = ({ assets }) => {
  ...
  return (0, import_jsx_runtime11.jsx)(Um.Root, {
    gap: 4,
    children: assets.map((asset) => (0, import_jsx_runtime11.jsx)(Um.Item, {
      col: 3,
      m: 4,
      s: 6,
      xs: 12,
      direction: "column",
      alignItems: "stretch",
      children: (0, import_jsx_runtime11.jsx)(AssetCard, {
        asset
      })
    }, asset.id))
  });
...
var AssetPreviewCell = ({ asset }) => {
  ...
  const DocIcon = getAssetIcon(mime, ext);
  return (0, import_jsx_runtime12.jsx)(T, {
    justifyContent: "center",
    alignItems: "center",
    borderRadius: "4px",
    color: "neutral500",
...
var AssetRow = ({ asset }) => {
  ...
  return (0, import_jsx_runtime12.jsxs)(StyledTr, {
    children: [
      (0, import_jsx_runtime12.jsx)(StyledTd, {
        children: (0, import_jsx_runtime12.jsxs)(T, {
          gap: 3,
          alignItems: "center",
          children: [
            (0, import_jsx_runtime12.jsx)(AssetPreviewCell, {
              asset
            }),
            (0, import_jsx_runtime12.jsxs)(T, {
              direction: "column",
              alignItems: "flex-start",
              children: [
                (0, import_jsx_runtime12.jsx)(I, {
                  textColor: "neutral800",
                  fontWeight: "semiBold",
                  ellipsis: true,
                  children: asset.name
                }),
                isMobile && (0, import_jsx_runtime12.jsx)(I, {
                  textColor: "neutral600",
                  variant: "pi",
      ...
      !isMobile && (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, {
        children: [
          (0, import_jsx_runtime12.jsx)(StyledTd, {
      ...
      (0, import_jsx_runtime12.jsx)(StyledTd, {
        children: (0, import_jsx_runtime12.jsx)(T, {
          justifyContent: "flex-end",
          children: (0, import_jsx_runtime12.jsx)(ot, {
            label: formatMessage({
              id: getTranslationKey("control-card.more-actions"),
              defaultMessage: "More actions"
            }),
...
var AssetsTable = ({ assets }) => {
  ...
  return (0, import_jsx_runtime12.jsxs)(StyledTable, {
    colCount: visibleHeaders.length,
    rowCount: assets.length + 1,
    children: [
      (0, import_jsx_runtime12.jsx)(StyledThead, {
        children: (0, import_jsx_runtime12.jsx)(s0, {
          children: visibleHeaders.map((header) => {
            ...
            if (isVisuallyHidden) {
              return (0, import_jsx_runtime12.jsx)(StyledTh, {
                children: (0, import_jsx_runtime12.jsx)(lt2, {
                  children: formatMessage({
      ...
      (0, import_jsx_runtime12.jsx)(o0, {
        children: assets.length === 0 ? (0, import_jsx_runtime12.jsx)(s0, {
          children: (0, import_jsx_runtime12.jsx)(StyledBodyTd, {
        ...
        }) : assets.map((asset) => (0, import_jsx_runtime12.jsx)(AssetRow, {
          asset
        }, asset.id))
      })
    ]
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/components/DropZone/DropZoneWithOverlay.mjs
...
var UploadDropZoneProvider = ({ children, onDrop }) => {
  ...
  return (0, import_jsx_runtime13.jsx)(UploadDropZoneContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime13.jsx)(DropZoneWrapper, {
...
var DropZoneWithOverlay = ({ children }) => {
  ...
  return (0, import_jsx_runtime14.jsxs)(R, {
    position: "relative",
    children: [
      isDragging && (0, import_jsx_runtime14.jsx)(DropZoneOverlay, {}),
      children
    ]
  });
};
...
var AssetsView = ({ view }) => {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime15.jsx)(T, {
      justifyContent: "center",
      padding: 8,
      children: (0, import_jsx_runtime15.jsx)(Vd, {
        children: formatMessage({
          id: "app.loading",
  ...
  if (error) {
    return (0, import_jsx_runtime15.jsx)(R, {
      padding: 8,
      children: (0, import_jsx_runtime15.jsx)(I, {
        textColor: "danger600",
        children: formatMessage({
  ...
  if (isGridView) {
    return (0, import_jsx_runtime15.jsx)(AssetsGrid, {
      assets
    });
  }
  return (0, import_jsx_runtime15.jsx)(AssetsTable, {
    assets
  });
};
var StyledToggleGroup = lt(Root2)`
  display: flex;
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
  border-radius: ${({ theme }) => theme.borderRadius};
  overflow: hidden;
`;
var StyledToggleItem = lt(Item2)`
  display: flex;
  align-items: center;
...
var DropFilesMessage = ({ uploadDropZoneRef }) => {
  const { formatMessage } = useIntl();
  const { isDragging } = useUploadDropZone();
  const [leftContentWidth, setLeftContentWidth] = (0, import_react5.useState)(0);
  ...
  return (0, import_jsx_runtime15.jsxs)(DropFilesMessageImpl, {
    $leftContentWidth: leftContentWidth,
    children: [
      (0, import_jsx_runtime15.jsx)(I, {
        textColor: "neutral0",
        children: formatMessage({
      ...
      (0, import_jsx_runtime15.jsxs)(T, {
        gap: 2,
        alignItems: "center",
        children: [
          (0, import_jsx_runtime15.jsx)(K5, {
            width: 20,
            height: 20,
            fill: "neutral0"
          }),
...
var AssetsPage = () => {
  ...
  const uploadDropZoneRef = (0, import_react5.useRef)(null);
  ...
  return (0, import_jsx_runtime15.jsx)(UploadDropZoneProvider, {
    onDrop: handleDrop,
    children: (0, import_jsx_runtime15.jsx)(R, {
      ref: uploadDropZoneRef,
      children: (0, import_jsx_runtime15.jsxs)(Layouts.Root, {
        minHeight: "100vh",
        children: [
          (0, import_jsx_runtime15.jsx)(lt2, {
          ...
          (0, import_jsx_runtime15.jsx)(DropFilesMessage, {
            uploadDropZoneRef
          }),
          (0, import_jsx_runtime15.jsx)(Layouts.Header, {
            navigationAction: (0, import_jsx_runtime15.jsx)(R, {
              children: "TODO: Breadcrumbs"
            }),
            title: "TODO: Folder location",
            primaryAction: (0, import_jsx_runtime15.jsxs)(T, {
              gap: 2,
              children: [
                (0, import_jsx_runtime15.jsx)(ad, {
                  popoverPlacement: "bottom-end",
                  variant: "default",
                  endIcon: (0, import_jsx_runtime15.jsx)(c5, {}),
                  label: formatMessage({
                    id: getTranslationKey("new"),
                    defaultMessage: "New"
                  }),
                  children: (0, import_jsx_runtime15.jsx)(Tm, {
                    onSelect: handleFileSelect,
                    startIcon: (0, import_jsx_runtime15.jsx)(N5, {}),
                    children: formatMessage({
                ...
                (0, import_jsx_runtime15.jsx)(SearchInput, {
                  label: formatMessage({
                ...
                (0, import_jsx_runtime15.jsxs)(StyledToggleGroup, {
                  type: "single",
                  ...
                  children: [
                    (0, import_jsx_runtime15.jsxs)(StyledToggleItem, {
                      value: "table",
                      "aria-label": formatMessage({
          ...
          (0, import_jsx_runtime15.jsx)(Layouts.Content, {
            children: (0, import_jsx_runtime15.jsx)(DropZoneWithOverlay, {
              children: (0, import_jsx_runtime15.jsx)(AssetsView, {
                view
              })
            })
          })
...
var UnstableMediaLibrary = () => {
  ...
  return (0, import_jsx_runtime16.jsxs)(Page.Main, {
    children: [
      (0, import_jsx_runtime16.jsx)(Page.Title, {
        children: title
      }),
      (0, import_jsx_runtime16.jsxs)(Routes, {
        children: [
          (0, import_jsx_runtime16.jsx)(Route, {
            index: true,
            element: (0, import_jsx_runtime16.jsx)(AssetsPage, {})
          }),
          (0, import_jsx_runtime16.jsx)(Route, {
            path: "ai-generation",
            element: (0, import_jsx_runtime16.jsx)(AIGenerationPage, {})
          })
        ]
      })
    ]
...
//# sourceMappingURL=App-KB24UGMU.js.map
