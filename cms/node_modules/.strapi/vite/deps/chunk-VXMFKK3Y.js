...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-MGOW7I5M.js");
    case "./translations/ca.json":
      return import("./ca.json-2QC23W2O.js");
    case "./translations/cs.json":
      return import("./cs.json-YPSGSYZD.js");
    case "./translations/de.json":
      return import("./de.json-MQ2CAWIM.js");
    case "./translations/en.json":
      return import("./en.json-3FSAVPVU.js");
    case "./translations/es.json":
      return import("./es.json-RWT3BURC.js");
    case "./translations/eu.json":
      return import("./eu.json-A3EO73IN.js");
    case "./translations/fr.json":
      return import("./fr.json-4AXYEJZM.js");
    case "./translations/gu.json":
      return import("./gu.json-LYL3ZYYH.js");
    case "./translations/hi.json":
      return import("./hi.json-4NKYU2RP.js");
    case "./translations/hu.json":
      return import("./hu.json-ZCE5TPUI.js");
    case "./translations/id.json":
      return import("./id.json-5OSIA6HF.js");
    case "./translations/it.json":
      return import("./it.json-5DDRBMF7.js");
    case "./translations/ja.json":
      return import("./ja.json-BU7H76HP.js");
    case "./translations/ko.json":
      return import("./ko.json-ORFYDNJC.js");
    case "./translations/ml.json":
      return import("./ml.json-ZRZITAG4.js");
    case "./translations/ms.json":
      return import("./ms.json-YCYW4KUP.js");
    case "./translations/nl.json":
      return import("./nl.json-BXZXRGRI.js");
    case "./translations/pl.json":
      return import("./pl.json-OPUJIYTY.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-G5AIGCDO.js");
    case "./translations/pt.json":
      return import("./pt.json-CH7HUYZX.js");
    case "./translations/ru.json":
      return import("./ru.json-UR64GUQ5.js");
    case "./translations/sa.json":
      return import("./sa.json-3ZS356C4.js");
    case "./translations/sk.json":
      return import("./sk.json-OV47HTUN.js");
    case "./translations/sv.json":
      return import("./sv.json-RNOZMNR7.js");
    case "./translations/th.json":
      return import("./th.json-HDKJHFI4.js");
    case "./translations/tr.json":
      return import("./tr.json-PAZ6KNM6.js");
    case "./translations/uk.json":
      return import("./uk.json-HWHOTASX.js");
    case "./translations/vi.json":
      return import("./vi.json-HC55AWTQ.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-HR2K2QZZ.js");
    case "./translations/zh.json":
      return import("./zh.json-4XJPAVSM.js");
    default:
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-XTT5ENJD.js");
        return {
          Component: Layout
        };
      },
    ...
    app.widgets.register((widgets) => {
      const lastEditedWidget = {
        ...
        component: async () => {
          const { LastEditedWidget } = await import("./Widgets-LU2Z2B2G.js");
      ...
      const lastPublishedWidget = {
        ...
        component: async () => {
          const { LastPublishedWidget } = await import("./Widgets-LU2Z2B2G.js");
      ...
      const entriesWidget = {
        ...
        component: async () => {
          const { ChartEntriesWidget } = await import("./Widgets-LU2Z2B2G.js");
...
//# sourceMappingURL=chunk-VXMFKK3Y.js.map
